...
| XEP-0333 | Chat Markers | Partial | DM sends now include `markable` hints, incoming `displayed`/`acknowledged` markers upgrade outbound DM status to read, and local DM read updates publish `displayed` markers. |
