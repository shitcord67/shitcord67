...
const XEP_0156_XMPP_LOGIN_DISCOVERY_RUNTIME_GLOBAL = xepModule("xep-0156_xmpp-login-discovery-runtime", globalThis.SHITCORD67_XEP_0156_XMPP_LOGIN_DISCOVERY_RUNTIME);
const XEP_XMPP_COMMAND_RUNTIME_GLOBAL = xepModule("xep-xmpp-command-runtime", globalThis.SHITCORD67_XEP_XMPP_COMMAND_RUNTIME);
const XEP_DM_COMMAND_RUNTIME_GLOBAL = xepModule("xep-dm-command-runtime", globalThis.SHITCORD67_XEP_DM_COMMAND_RUNTIME);
const XEP_SLASH_COMMAND_RUNTIME_GLOBAL = xepModule("xep-slash-command-runtime", globalThis.SHITCORD67_XEP_SLASH_COMMAND_RUNTIME);
const XEP_XMPP_UI_BINDINGS_RUNTIME_GLOBAL = xepModule("xep-xmpp-ui-bindings-runtime", globalThis.SHITCORD67_XEP_XMPP_UI_BINDINGS_RUNTIME);
