...
const {
  ...
  XMPP_JINGLE_MESSAGE_INIT_COMPAT_NAMESPACES, XMPP_CALL_INVITES_NAMESPACE, XMPP_CALL_INVITES_NAMESPACE_PREFIX, XMPP_CALL_MESSAGE_NAMESPACE, XMPP_JINGLE_AUDIO_NAMESPACE,
...
const XMPP_CALL_ENABLE_RESPONDER_SESSION_INITIATE_FALLBACK = Boolean(
  XEP_APP_BOOTSTRAP.XMPP_CALL_ENABLE_RESPONDER_SESSION_INITIATE_FALLBACK
);
...
const SLASH_COMMANDS = [
  ...
  { name: "pins", args: "", description: "Open pinned messages for current conversation." },
  { name: "pin", args: "[message-id-prefix|last]", description: "Pin a specific message in the current conversation." },
  { name: "unpin", args: "[message-id-prefix|last]", description: "Unpin a specific message in the current conversation." },
  ...
  { name: "categories", args: "", description: "List channel categories and visible channel counts." },
  ...
  { name: "findmedia", args: "", description: "Open find pre-filtered to messages with attachments." },
  { name: "findreactions", args: "", description: "Open find pre-filtered to messages with reactions." },
  { name: "findpolls", args: "", description: "Open find pre-filtered to messages with polls." },
  { name: "findpinned", args: "", description: "Open find pre-filtered to pinned messages." },
  ...
  { name: "movecategory", args: "<name|id> <up|down|top|bottom>", description: "Reorder a category in the active guild (manage channels)." },
